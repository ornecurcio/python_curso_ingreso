...
---
Enunciado:
Al presionar el botón  'Calcular', se deberán obtener los 
valores contenidos en las cajas de texto (txtSueldo y txtIncremento), 
...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        ...
        sueldo_total = int(sueldo)+(int(sueldo) * int(incremento)/100)
        mensaje = "El sueldo total con {0}% de aumento es {1}".format(incremento,sueldo_total)
