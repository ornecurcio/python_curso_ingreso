...
'''
Luego de presionar el botón 'Iniciar',se disparara ; 
un temporizador de una función que haga visible los tres botones ocultos. 
Se deberá calcular e informar la cantidad de segundos transcurridos 
desde que estos botones se hicieron visibles hasta el momento 
...
class App(customtkinter.CTk):
    ...
    def btn_check_all_press(self):
        ts_fin= time.time()
        tiempo_de_juego= ts_fin - self.ts_inicio
        mensaje= "su tiempo fue {0}".format(tiempo_de_juego)
