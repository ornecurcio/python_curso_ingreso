...
'''
Al presionar el botón INICIAR se debe mostrar un mensaje de bienvenida
"Bienvenidos a la UTN FRA" 
...
class App(customtkinter.CTk):
    ...
    def btn_cancelar_on_click(self):
        self.after_cancel(self.id_mostar_alert)

    def mostrar_mensaje(self):
        self.contador = self.contador + 1
        mensaje = "Bienvenido a UTN Fra - Contador {0}".format(self.contador)
        alert(title="",message= mensaje)
        self.id_mostar_alert=self.after(3000,self.mostrar_mensaje)
